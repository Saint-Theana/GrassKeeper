...
public class ItemAddHintNotify {
    ...
    @Tag(tag=15) public Boolean isGeneralRewardHiden = null;
    @Tag(tag=10) public List<ItemHint> itemList = new ArrayList<>();
    @Tag(tag=12) public Boolean isTransferedFromAvatarCard = null;
    @Tag(tag=9) public Vector position = null;
    @Tag(tag=8) public List<ItemHint> overflowTransformedItemList = new ArrayList<>();
}
